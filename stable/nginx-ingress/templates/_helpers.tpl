...
{{- printf "%s-%s" (include "common.fullname" .) .Values.controller.name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- else -}}
{{- default (include "common.fullname" .) .Values.controller.config.name -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
{{- printf "%s-agent-config"  (include "common.fullname" . | trunc 49 | trimSuffix "-") -}}
{{- end -}}
{{- end -}}
...
{{- else -}}
{{- printf "%s-%s" (include "common.fullname" .) "leader-election" -}}
{{- end -}}
{{- end -}}
...
{{- printf "%s-%s" (include "common.fullname" .) "default-server-tls" -}}
{{- end -}}
...
{{- printf "%s-%s" (include "common.fullname" .) "wildcard-tls" -}}
{{- end -}}
...
{{- printf "%s-%s" (include "common.fullname" .) "prometheus-service"  -}}
{{- end -}}
